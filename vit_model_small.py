...
class PatchEmbed(nn.Module):
    def __init__(self, input_size=(75,120), patch_size=15, in_c=3, embed_dim=675, norm_layer=None):
        super().__init__()
...
class VisionTransformer(nn.Module):
    def __init__(self, input_size=(75,120), patch_size=15, in_c=3,
        ...
        """
        Args:
            input_size (int, tuple): input  size：75*120
        ...
        #output layer
        self.head = nn.Linear(27000, 9000)
...
def vit_base_patch15_75_120():
    model = VisionTransformer(input_size=(75,120),
                              patch_size=15,
                              embed_dim=675,
                              depth=8,
                              num_heads=15)
